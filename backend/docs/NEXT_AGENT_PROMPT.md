...
- Current automated baseline (2026-08-04): renderer 38 files/224 tests, desktop 144 tests, backend 31 tests, backend typecheck pass, production renderer build pass, and strict codesign verification of the local ad-hoc hardened-runtime QA bundle. The Developer ID identity was unavailable, so this is not distribution-signing evidence.
