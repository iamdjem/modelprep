...
const RULES = {
  ...
  makerworld: [/^category$/i, /original model license/i, /what did you change/i, /print-profile name/i, /profile name/i],
  // The label reads "Printables category", so the rule cannot be anchored.
  printables: [/categor/i],
  cults: [/category/i, /licen[cs]e/i, /^price/i],
  ...
  mmf: [/category/i, /licen[cs]e/i, /visibility/i],
  makeroad: [/categor/i, /print method/i, /publication time|publish at/i],
  thingiverse: [/category/i],
  thangs: [/primary part/i],
};
